...
def cacheStillCurrent(soup, cached):
  return epochDate(parse(soup.updated.text)) < cached.lastUpdate
...
def jsonifySAS(cache = CachedResult()):
  return jsonifySeminars("http://www3.imperial.ac.uk/imperialnewsevents/eventsfront?pid=6191_178198110_6191_178198049_178198049", getEventList, cache, cacheStillCurrent)

#IC TAKTIC: Topology and Knot Theory at Imperial College
def jsonifyTAKTIC(cache = CachedResult()):
  return jsonifySeminars("http://www3.imperial.ac.uk/imperialnewsevents/eventsfront?pid=5672_184390848_5672_184390833_184390833", getEventList, cache, cacheStillCurrent)

#IC Applied PDEs Seminars
def jsonifyAPDE(cache = CachedResult()):
  return jsonifySeminars("http://www3.imperial.ac.uk/imperialnewsevents/eventsfront?pid=116_179821488_116_179794307_179794307", getEventList, cache, cacheStillCurrent)

#IC Applied Mathematics and Mathematical Physics Seminar
def jsonifyAMMP(cache = CachedResult()):
  return jsonifySeminars("http://www3.imperial.ac.uk/imperialnewsevents/eventsfront?pid=116_177737061_116_177736608_177736608", getEventList, cache, cacheStillCurrent)

#IC Fluid dynamics group seminar
def jsonifyFD(cache = CachedResult()):
  return jsonifySeminars("http://www3.imperial.ac.uk/imperialnewsevents/eventsfront?pid=5732_177343692_5732_177334749_177334749", getEventList, cache, cacheStillCurrent)
