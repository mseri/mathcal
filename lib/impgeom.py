# -*- encoding: utf-8 -*-
from lib.helpers import jsonifySeminars, re, parse, CachedResult
...
def jsonifyIPGAS(cache=CachedResult()):
  return jsonifySeminars("http://geometry.ma.ic.ac.uk/gaseminar/",
                         getEventListGAS, cache)


#IC The London Topology and Geometry Seminar
def jsonifyIPLTGS(cache=CachedResult()):
  return jsonifySeminars("http://geometry.ma.ic.ac.uk/seminar/",
                         getEventListLTGS, cache)
